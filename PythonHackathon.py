# -*- coding: utf-8 -*-
"""Monerah-FB-Growth.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AXnK8o77uiZ-WRSAbO81rfQzYpPJ6bqI
"""
...
data = pd.read_csv('TEST_DATA1.csv') # Here I put the file.CSV to read 

# My Parameters (Support & Confidence)
minsup=0.0002 #float(input("Enter Support-Threshold: "))
minsup=minsup*len(data)
minconf=0.0005 #float(input("Enter Confidence-Threshold: "))

#Here add all data in a list of lists I update this to satisfy my need since I have bigger data size
items = []
for i in range(0, len(data)):  
    items.append([str(data.values[i,j]) for j in range(0, len(data.values[0]))])
count = [dict() for x in range(len(data.values[0])+1)]

#Here count support for each individual items
s=[]
for i in items:
    for j in i:
        s.append(j)
...
#This is the function of sorting list to support
def sort(a):
